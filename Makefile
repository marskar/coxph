...
.git/:
	curl --user 'marskar' https://api.github.com/user/repos --data '{"name":"coxph","description":"A short description of the project."}'
	test -f README.rst || echo "coxph" >> README.rst
	git init
	git add --all
	git commit --message "First commit"
	git remote add origin https://github.com/marskar/coxph.git
